...
class OrderCrudController extends AbstractCrudController
{
    ...
    public function updatePreparation(AdminContext $context, Request $request)
    {
    ...
    public function updateDelivery(AdminContext $context, Request $request)
    {
        $order = $context->getEntity()->getInstance();
        $order->setState(3);
        $this->entityManager->flush();
    ...
    {
        //inverse l'incrémentation des id dans easy admin
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            ArrayField::new('oderDetails', 'Produits achetés')->hideOnIndex()
        ];
    }
